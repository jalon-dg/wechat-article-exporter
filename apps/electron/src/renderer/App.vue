<template>
  <div class="app">
    ...
    <div class="main-content">
      ...
      <CollectStep v-if="currentStep === 2" @next="goToStep(3)" @prev="goToStep(1)" :key="stepKeys[1]" />
      <ExportStep v-if="currentStep === 3" @prev="goToStep(2)" @done="finish" :key="stepKeys[2]" />
    </div>
  </div>
</template>
